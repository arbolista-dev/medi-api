...
function getSession(args) {
  if (args.id) {
    return getSessionByID(args.id, args.user_id)
  } else if (args.user_id) {
    return getSessionByUser(args.user_id, args.start_date, args.end_date)
  } else {
    return getAllSessions(args.start_date, args.end_date)
  }
}

function getSessionByID(id, user_id) {
...
function getSessionByUser(user_id, start, end) {
  if (start && end) {
...
function getAllSessions(start, end) {
  if (start && end) {
    let _start = stringDateToInt(start)
    let _end = stringDateToInt(end)
...
function deleteSession(id, user_id) {
  if (id) {
...
export { getSession, getSessionByUser, updateSession, deleteSession }
