...
insert into users (id, email, first_name, last_name, hash) values
  (1, 'jimmy@example.com', 'Jimmy', 'Hendrix', '$2a$10$lyjtsTZD3KzQoOInr.MLM.m5tOoIK41KwlfmwSSOXIModNBPTZ9Py'),
  (2, 'test2@example.com', 'Jamie', 'Thomas', '$2a$10$khZGWCAoBLbY/B4jkEnBGeKHqv69H1eFJkxzlenQlbVB83GUrzJ5G'),
  (3, 'test3@example.com', 'Thomas', 'Cook', '$2a$10$3WeqXz8CeEgS22DwTattAe8q25s3cc/NONrcF9FV8ih9rOV.lk6lm');

alter sequence users_id_seq restart with 4;

insert into sessions (id, user_id, status, date, duration_planned, duration_success, location, note) values
  (1, 1, true, '2016-04-27 04:05:06', 600, 600, 'At home', 'Good day'),
  (2, 1, false, '2016-03-27 08:05:06', 1200, 900, 'In the park', 'Bad day'),
  (3, 2, true, '2016-04-24 04:05:06', 600, 600, 'In bed', 'Rainy day'),
  (4, 2, true, '2016-04-22 04:05:06', 600, 600, 'In the metro', 'Busy day');
